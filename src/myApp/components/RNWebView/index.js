            ...
            <View style={styles.container}>
                ...
                >
                    <Animated.View style={[styles.scrollViewContent,{opacity:this.state.fadeOutOpacity}]} >
                        {this.state.isError ?
                            <TouchableOpacity onPress={this._reload.bind(this)} activeOpacity={0.8} style={{height:50}}>
                ...
                <WebView
                    ...
                    style={{width:cfn.deviceWidth(),height:cfn.deviceHeight(),backgroundColor:'#fff'}}
